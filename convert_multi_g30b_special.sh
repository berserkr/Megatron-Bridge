...
#SBATCH --nodes=8
#SBATCH --job-name=granite-export
...
LOCAL_HF_CKPT=/mnt/vast/proj/checkpoints/bathen/models/base/30b-soft-lc-512k-lr1e-4-merged-3-7-special
SAVED_CKPT=/mnt/vast/proj/checkpoints/bathen/models/nemo_run/granite30b_sft_128k_special/iter_0002000
EXPORTED_CKPT=/mnt/vast/proj/checkpoints/bathen/models/exports/granite30b_sft_128k_special
